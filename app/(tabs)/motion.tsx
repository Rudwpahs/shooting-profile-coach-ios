...
export default function MotionStudioScreen() {
  ...
  return <ScreenContainer containerClassName="bg-background">
    ...
    <ScrollView contentContainerStyle={styles.page} showsVerticalScrollIndicator={false}>
      <View style={styles.header}><View><Text style={styles.kicker}>FORMPATH / FILM ROOM</Text><Text style={styles.title}>모션 랩</Text></View><View style={styles.analysisBadge}><MaterialIcons name="visibility" size={14} color={tokens.warning} /><Text style={styles.analysisBadgeText}>분석용</Text></View></View>
      ...
      <View style={styles.analysisNote}><MaterialIcons name="auto-fix-high" size={16} color={tokens.warning} /><Text style={styles.analysisNoteText}>{selected.state === "image_lifted_pose_estimate_not_actual_3d" ? "MotionBERT 2D keypoint trajectory → temporal camera-relative depth lift · 분석용" : selected.autoCorrection ? "관절 방향·슛 단계 유지 · 성인 비율 길이 보정 · 분석용" : "제한 depth · "}{selected.state === "image_lifted_pose_estimate_not_actual_3d" || selected.autoCorrection ? "개인 신체 측정·실제 3D·추천에는 사용하지 않습니다." : selected.depthTreatment}</Text></View>

      <View style={styles.referenceHeader}><View><Text style={styles.referenceEyebrow}>VERIFIED REFERENCE</Text><Text style={styles.referenceTitle}>실제 3D 기준 모션</Text></View><View style={styles.verifiedBadge}><MaterialIcons name="verified" size={14} color={tokens.positive} /><Text style={styles.verifiedText}>승인됨</Text></View></View>
      ...
      <Pressable onPress={() => router.navigate("/profile" as never)} style={({ pressed }) => [styles.compareButton, pressed && styles.pressed]}><MaterialIcons name="person-outline" size={19} color={tokens.foreground} /><Text style={styles.compareText}>내 기록과 비교하기</Text></Pressable>
    </ScrollView>
  </ScreenContainer>;
}
...
const styles = StyleSheet.create({
  ...
  arc: { borderColor: tokens.border, borderRadius: 270, borderWidth: 1, height: 390, position: "absolute", right: -225, top: -156, width: 390 },
  trackLine: { backgroundColor: tokens.positiveSoft, height: 1, left: 0, position: "absolute", top: 148, width: 74 },
  page: { alignSelf: "center", maxWidth: 760, paddingBottom: 32, paddingHorizontal: 16, paddingTop: 20, width: "100%" },
  ...
  analysisBadge: { alignItems: "center", backgroundColor: tokens.warningSoft, borderRadius: 12, flexDirection: "row", gap: 5, paddingHorizontal: 9, paddingVertical: 6 },
  analysisBadgeText: { color: tokens.warning, fontFamily: "BarlowCondensed-Bold", fontSize: 11, letterSpacing: 0.7 },
  lead: { color: tokens.mutedForeground, fontFamily: "Barlow", fontSize: 14, lineHeight: 20, marginTop: 11 },
  selector: { marginTop: 21 },
  selectorLabel: { color: tokens.mutedForeground, fontFamily: "BarlowCondensed-Bold", fontSize: 11, letterSpacing: 1.1 },
  chipRow: { gap: 8, paddingTop: 9 },
  chip: { backgroundColor: tokens.surface, borderColor: tokens.border, borderRadius: 13, borderWidth: 1, minHeight: 38, paddingHorizontal: 12, justifyContent: "center" },
  chipActive: { backgroundColor: tokens.elevatedSurface, borderColor: tokens.border },
  chipText: { color: tokens.mutedForeground, fontFamily: "BarlowCondensed-Bold", fontSize: 13 },
  chipTextActive: { color: tokens.foreground },
  filmHeader: { alignItems: "flex-end", flexDirection: "row", justifyContent: "space-between", marginTop: 25 },
  filmEyebrow: { color: tokens.primary, fontFamily: "BarlowCondensed-Bold", fontSize: 11, letterSpacing: 1.2 },
  filmTitle: { color: tokens.foreground, fontFamily: "BarlowCondensed-Bold", fontSize: 29, marginTop: 1 },
  viewPill: { backgroundColor: tokens.positiveSoft, borderRadius: 12, paddingHorizontal: 8, paddingVertical: 5 },
  viewPillText: { color: tokens.positive, fontFamily: "BarlowCondensed-Bold", fontSize: 10, letterSpacing: 0.8 },
  viewerShell: { marginTop: 10 },
  analysisNote: { alignItems: "center", backgroundColor: tokens.warningSoft, borderRadius: 12, flexDirection: "row", gap: 7, marginTop: 10, paddingHorizontal: 11, paddingVertical: 9 },
  analysisNoteText: { color: tokens.warning, flex: 1, fontFamily: "Barlow", fontSize: 11, lineHeight: 15 },
  referenceHeader: { alignItems: "flex-end", flexDirection: "row", justifyContent: "space-between", marginTop: 29 },
  referenceEyebrow: { color: tokens.positive, fontFamily: "BarlowCondensed-Bold", fontSize: 11, letterSpacing: 1.1 },
  referenceTitle: { color: tokens.foreground, fontFamily: "BarlowCondensed-Bold", fontSize: 29, marginTop: 1 },
  verifiedBadge: { alignItems: "center", backgroundColor: tokens.positiveSoft, borderRadius: 12, flexDirection: "row", gap: 5, paddingHorizontal: 8, paddingVertical: 5 },
  verifiedText: { color: tokens.positive, fontFamily: "BarlowCondensed-Bold", fontSize: 10 },
  referenceShell: { marginTop: 10 },
  compareButton: { alignItems: "center", backgroundColor: tokens.elevatedSurface, borderRadius: 16, flexDirection: "row", gap: 8, justifyContent: "center", marginTop: 12, minHeight: 50 },
  compareText: { color: tokens.foreground, fontFamily: "BarlowCondensed-Bold", fontSize: 16, letterSpacing: 0.35 },
