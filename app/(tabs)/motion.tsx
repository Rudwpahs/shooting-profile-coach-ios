...
export default function MotionStudioScreen() {
  ...
  const candidate = PLAYER_VIDEO_POSE_CANDIDATES[0];
  return <ScreenContainer>
    ...
    <ScrollView contentContainerStyle={styles.page} showsVerticalScrollIndicator={false}>
      ...
      <Text style={styles.lead}>사용자가 제공한 정면 슬로모션에서 추출한 33-landmark 상대 pose입니다. 단계 오른쪽 시간은 원본 영상 timestamp이며, 3D metric model·추천 reference로는 아직 승인되지 않았습니다.</Text>
      ...
      <View style={styles.sourceCard}><View style={styles.sourceIcon}><MaterialIcons name="videocam" size={20} color="#EA580C" /></View><View style={styles.sourceTextWrap}><Text style={styles.sourceTitle}>Curry 영상 후보 · 검토 중</Text><Text style={styles.sourceCopy}>{candidate.sourceAttribution}</Text></View></View>
