...
export default function MotionStudioScreen() {
  ...
  return <ScreenContainer>
    ...
    <ScrollView contentContainerStyle={styles.page} showsVerticalScrollIndicator={false}>
      ...
      <Text style={styles.lead}>검증된 실제 optical-mocap 모션만 표시합니다. 회전·확대·단계 선택으로 릴리스와 팔로우스루를 확인하세요.</Text>
      <View style={styles.viewerWrap}><PoseMotionViewer motion={reference.motion} title={reference.shortLabel} boundary="익명 actual optical-mocap 3D입니다. 특정 선수의 이름·영상·개인 식별자는 표시하지 않습니다." hand="right" /></View>
