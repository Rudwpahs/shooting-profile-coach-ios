  ...
  return (
    <ScreenContainer>
      <ScrollView contentContainerStyle={styles.page} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.detail}>회전 가능한 3D는 재현 가능한 actual optical motion으로 한정합니다. 단일 선수 영상은 audit 기록으로만 보관합니다.</Text>
        ...
        <Text style={styles.candidateEyebrow}>WITHDRAWN VIDEO REVIEWS · NO 3D MODEL</Text>
