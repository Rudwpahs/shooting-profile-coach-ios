...
/** Active product library. Only anonymous, provenance-backed reference data may enter it. */
...
export const ANONYMOUS_POSE_LIBRARY_STATUS = {
  ...
  // Historical player-review evidence remains in a research-only module and is not shipped by product routes.
  withdrawnVideoReviewCount: 2,
  visiblePlayerIdentity: false,
  namingMode: "anonymous_reference_only",
